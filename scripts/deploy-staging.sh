...
# This script mirrors the GitLab CI/CD deploy:staging stage for local deployment
#
...
echo "========================================="
echo "EshopMicroservices - Staging Deployment"
echo "========================================="
echo ""
...
if [ ! -f "$HELM_CHART_PATH/values-staging.yaml" ]; then
  echo "ERROR: values-staging.yaml not found at $HELM_CHART_PATH/values-staging.yaml"
  echo "Press Enter to exit..."
  read -r
  exit 1
fi
...
helm upgrade --install "$RELEASE_NAME" "$HELM_CHART_PATH" \
  ...
  --wait --timeout 15m \
  --debug 2>&1 | tee helm-deploy-staging.log
...
if [ $HELM_EXIT_CODE -ne 0 ]; then
  ...
  echo "========================================="
  echo "Check helm-deploy-staging.log for details"
  echo ""
...
echo ""
echo "========================================="
echo "Access URLs (Staging):"
echo "========================================="
echo ""
echo "Shopping Web:     http://eshop-staging.lgharbi-eshop-cluster-k8s-8a833d5c3d6a9b7ed1b32c0af11fc140-0000.eu-de.containers.appdomain.cloud"
echo "API Gateway:      http://api-staging.lgharbi-eshop-cluster-k8s-8a833d5c3d6a9b7ed1b32c0af11fc140-0000.eu-de.containers.appdomain.cloud"
echo "Health Dashboard: http://health-staging.lgharbi-eshop-cluster-k8s-8a833d5c3d6a9b7ed1b32c0af11fc140-0000.eu-de.containers.appdomain.cloud"
echo "Kibana:           http://kibana-staging.lgharbi-eshop-cluster-k8s-8a833d5c3d6a9b7ed1b32c0af11fc140-0000.eu-de.containers.appdomain.cloud"
echo ""
echo "========================================="
